...
function em_load_map(page,element)
{  
    if(!em_map_info.gmap_uri)
    {
        em_jQuery("#" + element).remove();
        return;
    }
    
    if (!(typeof google === 'object' && typeof google.maps === 'object')){
        
        em_jQuery.getScript(em_map_info.gmap_uri)
        .done(function( script, textStatus ) {
            em_load_map_div(page);
        })
...
function em_load_map_div(page)
{
 
    switch(page)
    {
                case "single_event":  var venue_id= em_jQuery("#em_event_map_canvas").attr("data-venue-id");
                                      em_event_map_canvas("em_event_map_canvas",venue_id); break;
                case "user_profile": var venue_id= em_jQuery("#em_user_event_venue_canvas").attr("data-venue-ids");
                                     em_user_event_venue("em_user_event_venue_canvas",venue_id);   break;
                case "venues": em_show_venue_map("venues_map_canvas"); break; 
                case "venue_widget" : em_show_venue_map("em_widget_venues_map_canvas"); break;
                case "single_venue":  var venue_id= em_jQuery("#em_single_venue_map_canvas").attr("data-venue-id");
                                      em_single_venue_map_canvas("em_single_venue_map_canvas",venue_id); break;
                case "booking" : var venue_id= em_jQuery("#em_booking_map_canvas").attr("data-venue-id");
                                      em_booking_map_canvas("em_booking_map_canvas",venue_id); break;
   }
}